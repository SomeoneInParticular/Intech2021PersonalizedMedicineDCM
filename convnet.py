...
if __name__ == '__main__':
    ...
    parser.add_argument('-sc', '--simple_cycles',
                        help='The number of Simple CNN models which should be trained from scratch',
                        type=int)
    parser.add_argument('-pc', '--paired_cycles',
                        help='The number of paired CNN/Dense models which should be trained from scratch',
                        type=int)
    ...
    simple_cycles = args.simple_cycles
    paired_cycles = args.paired_cycles
    epochs = args.epochs
    ...
    for cycle in range(paired_cycles):
        base_data = {
